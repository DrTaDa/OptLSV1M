...
def analysis(data_store, analog_ids, analog_ids_inh, analog_ids23=None, analog_ids_inh23=None):
    ...
    dsv = param_filter_query(
        data_store, st_name='InternalStimulus', st_direct_stimulation_name=None, sheet_name=sheets)
...
def perform_analysis_and_visualization_stc(data_store, run_id):
    ...
    if paper_figures:
        if l23:
            SizeTuningOverviewNew(data_store, ParameterSet({'l4_neurons': list(center4), 'l23_neurons': list(center23), 'l4_neurons_analog': list(
                analog_center4), 'l23_neurons_analog': list(analog_center23)}), plot_file_name=f'Fig9_{run_id}.png', fig_param={'dpi': dpi, 'figsize': (18, 11)}).plot()
        else:
            SizeTuningOverviewNew(data_store, ParameterSet({'l4_neurons': list(center4), 'l23_neurons': [], 'l4_neurons_analog': list(
                analog_center4), 'l23_neurons_analog': []}), plot_file_name=f'Fig9_{run_id}.png', fig_param={'dpi': dpi, 'figsize': (18, 11)}).plot()
        ...
        if l23:
            PlotTuningCurve(dsv, ParameterSet({'parameter_name': 'radius', 'neurons': list(center23), 'sheet_name': 'V1_Exc_L2/3', 'centered': False,
                                               'mean': False, 'polar': False, 'pool': False}), plot_file_name=f'SizeTuningExcL23_{run_id}.png', fig_param={'dpi': 100, 'figsize': (32, 7)}).plot()
            PlotTuningCurve(dsv, ParameterSet({'parameter_name': 'radius', 'neurons': list(center23), 'sheet_name': 'V1_Exc_L2/3', 'centered': False,
                                               'mean': True, 'polar': False, 'pool': False}), plot_file_name=f'SizeTuningExcL23M_{run_id}.png', fig_param={'dpi': 100, 'figsize': (32, 7)}).plot()
        ...
        if True:
            ...
            }, 'spontaneous': True}), fig_param={'dpi': 100, 'figsize': (28, 12)}, plot_file_name=f'Overview_ExcL4_1_{run_id}.png').plot()

            if l23:
                OverviewPlot(dsv, ParameterSet({'sheet_name': 'V1_Exc_L2/3', 'neuron': list(analog_center23)[0], 'sheet_activity': {
                }, 'spontaneous': True}), fig_param={'dpi': 100, 'figsize': (28, 12)}, plot_file_name=f'Overview_ExcL23_1_{run_id}.png').plot()

        if l23:
            SizeTuningOverview(data_store, ParameterSet({'l4_neurons': list(center4), 'l23_neurons': list(center23), 'l4_neurons_analog': list(
                analog_center4), 'l23_neurons_analog': list(analog_center23)}), plot_file_name=f'SizeTuningOverview_{run_id}.png', fig_param={'dpi': 300, 'figsize': (18, 8)}).plot()
            SizeTuningOverviewNew(data_store, ParameterSet({'l4_neurons': list(center4), 'l23_neurons': list(center23), 'l4_neurons_analog': list(
                analog_center4), 'l23_neurons_analog': list(analog_center23)}), plot_file_name=f'SizeTuningOverviewNew_{run_id}.png', fig_param={'dpi': dpi, 'figsize': (18, 11)}).plot()
        else:
            SizeTuningOverview(data_store, ParameterSet({'l4_neurons': list(center4), 'l23_neurons': None, 'l4_neurons_analog': list(
                analog_center4), 'l23_neurons_analog': None}), plot_file_name=f'SizeTuningOverview_{run_id}.png', fig_param={'dpi': 300, 'figsize': (18, 8)}).plot()
            SizeTuningOverviewNew(data_store, ParameterSet({'l4_neurons': list(center4), 'l23_neurons': [], 'l4_neurons_analog': list(
                analog_center4), 'l23_neurons_analog': []}), plot_file_name=f'SizeTuningOverviewNew_{run_id}.png', fig_param={'dpi': dpi, 'figsize': (18, 11)}).plot()


def perform_analysis_and_visualization(data_store, run_id):
        ...
        if paper_figures:
            if l23_flag:
                OrientationTuningSummaryAnalogSignals(data_store, ParameterSet({'exc_sheet_name1': 'V1_Exc_L4', 'inh_sheet_name1': 'V1_Inh_L4', 'exc_sheet_name2': 'V1_Exc_L2/3', 'inh_sheet_name2': 'V1_Inh_L2/3'}), fig_param={
                                                      'dpi': dpi, 'figsize': (18, 12)}, plot_file_name=f'Fig7_{run_id}.png').plot({'*.fontsize': 19, '*.y_lim': (0, None)})
                OrientationTuningSummaryFiringRates(data_store, ParameterSet({'exc_sheet_name1': 'V1_Exc_L4', 'inh_sheet_name1': 'V1_Inh_L4', 'exc_sheet_name2': 'V1_Exc_L2/3', 'inh_sheet_name2': 'V1_Inh_L2/3'}), fig_param={
                                                    'dpi': dpi, 'figsize': (18, 12)}, plot_file_name=f'Fig6_{run_id}.png').plot({'*.fontsize': 19})
                TrialToTrialVariabilityComparisonNew(data_store, ParameterSet({'sheet_name1': 'V1_Exc_L4', 'sheet_name2': 'V1_Exc_L2/3', 'data_dg': 0.93, 'data_ni': 1.19}), fig_param={
                                                     'dpi': dpi, 'figsize': (15, 7.5)}, plot_file_name=f'Fig10GHI_{run_id}.png').plot()
            else:
            ...
            if l23_flag:
                MRfigReal(param_filter_query(data_store, sheet_name=['V1_Exc_L2/3', 'V1_Exc_L4', 'V1_Inh_L2/3', 'V1_Inh_L4'], st_contrast=[high_contrast], st_name='FullfieldDriftingSinusoidalGrating'), ParameterSet(
                    {'SimpleSheetName': 'V1_Exc_L4', 'ComplexSheetName': 'V1_Exc_L2/3'}), plot_file_name=f'Fig8_{run_id}.png', fig_param={'dpi': dpi, 'figsize': (20, 9)}).plot()
            else:
                MRfigReal(param_filter_query(data_store, sheet_name=['V1_Exc_L4', 'V1_Inh_L4'], st_contrast=[high_contrast], st_name='FullfieldDriftingSinusoidalGrating'), ParameterSet(
                    {'SimpleSheetName': 'V1_Exc_L4', 'ComplexSheetName': 'None'}), plot_file_name=f'Fig8_{run_id}.png', fig_param={'dpi': dpi, 'figsize': (16, 12)}).plot()

            TrialCrossCorrelationAnalysis(data_store, ParameterSet({'neurons1': list(analog_ids), 'sheet_name1': 'V1_Exc_L4', 'neurons2': list(
                analog_ids23), 'sheet_name2': 'V1_Exc_L2/3', 'window_length': 250}), fig_param={"dpi": dpi, "figsize": (15, 6.5)}, plot_file_name=f"Fig10CDE_{run_id}.png").plot({'*.Vm.title': None, '*.fontsize': 19})
            ...
            ({'l4_exc_neuron' : l4_exc_or_many_analog[0], 'l4_inh_neuron' : l4_inh_or_many_analog[3],'l23_exc_neuron' : l23_exc_or_many_analog[5], 'l23_inh_neuron' : l23_inh_or_many_analog[2]}),
                                             fig_param={'dpi' : dpi,'figsize': (18,9)},plot_file_name=f'Fig5_{run_id}.png').plot(
            ...
            StimulusResponseComparison(data_store,ParameterSet({'neuron' : l4_exc_or_many_analog[8],'sheet_name' : 'V1_Exc_L4'}),fig_param={'dpi' : dpi,'figsize': (18,6)},plot_file_name=f'Fig10AB_{run_id}.png').plot(
                                         {'*.Vm_plot.x_ticks':[0,2000],
                                         '*.Conductance_plot.x_ticks':[0,2000],
                                         "*.title" : None,
                                         '*.Vm_plot.y_lim' : (-80,-50),
            ...
            OrientationMapMatching(data_store,ParameterSet({}), plot_file_name=f'Fig2_{run_id}.png',fig_param={'dpi' : dpi,'figsize': (6,6)}).plot()
            ...
            }, 'spontaneous': True}), fig_param={'dpi': 100, 'figsize': (28, 12)}, plot_file_name=f'SSExcAnalog_{run_id}.png').plot()
            OverviewPlot(dsv, ParameterSet({'sheet_name': 'V1_Inh_L4', 'neuron': analog_ids_inh[0], 'sheet_activity': {
            }, 'spontaneous': True}), fig_param={'dpi': 100, 'figsize': (28, 12)}, plot_file_name=f'SSInhAnalog_{run_id}.png').plot()
            ...
            RasterPlot(dsv, ParameterSet({'sheet_name': 'V1_Exc_L4', 'neurons': spike_ids, 'trial_averaged_histogram': False, 'spontaneous': False}), fig_param={
                       'dpi': 100, 'figsize': (28, 12)}, plot_file_name=f'SSExcRasterL4_{run_id}.png').plot({'SpikeRasterPlot.group_trials': True})
            RasterPlot(dsv, ParameterSet({'sheet_name': 'V1_Inh_L4', 'neurons': spike_ids_inh, 'trial_averaged_histogram': False, 'spontaneous': False}), fig_param={
                       'dpi': 100, 'figsize': (28, 12)}, plot_file_name=f'SSInhRasterL4_{run_id}.png').plot({'SpikeRasterPlot.group_trials': True})
            if l23_flag:
                OverviewPlot(dsv, ParameterSet({'sheet_name': 'V1_Exc_L2/3', 'neuron': analog_ids23[0], 'sheet_activity': {
                }, 'spontaneous': True}), fig_param={'dpi': 100, 'figsize': (28, 12)}, plot_file_name=f'SSExcAnalog23_{run_id}.png').plot()
                OverviewPlot(dsv, ParameterSet({'sheet_name': 'V1_Inh_L2/3', 'neuron': analog_ids_inh23[0], 'sheet_activity': {
                }, 'spontaneous': True}), fig_param={'dpi': 100, 'figsize': (28, 12)}, plot_file_name=f'SSInhAnalog23_{run_id}.png').plot()

                RasterPlot(dsv, ParameterSet({'sheet_name': 'V1_Exc_L2/3', 'neurons': spike_ids23, 'trial_averaged_histogram': False, 'spontaneous': False}),
                           fig_param={'dpi': 100, 'figsize': (28, 12)}, plot_file_name=f'SSExcRasterL23_{run_id}.png').plot({'SpikeRasterPlot.group_trials': True})
                RasterPlot(dsv, ParameterSet({'sheet_name': 'V1_Inh_L2/3', 'neurons': spike_ids_inh23, 'trial_averaged_histogram': False, 'spontaneous': False}),
                           fig_param={'dpi': 100, 'figsize': (28, 12)}, plot_file_name=f'SSInhRasterL23_{run_id}.png').plot({'SpikeRasterPlot.group_trials': True})


            dsv = param_filter_query(
                data_store, st_name='FullfieldDriftingSinusoidalGrating')
            RasterPlot(dsv, ParameterSet({'sheet_name': 'V1_Exc_L4', 'neurons': spike_ids, 'trial_averaged_histogram': False, 'spontaneous': False}), fig_param={
                       'dpi': 100, 'figsize': (28, 12)}, plot_file_name=f'EvokedExcRaster_{run_id}.png').plot({'SpikeRasterPlot.group_trials': True})
            RasterPlot(dsv, ParameterSet({'sheet_name': 'V1_Inh_L4', 'neurons': spike_ids_inh, 'trial_averaged_histogram': False, 'spontaneous': False}), fig_param={
                       'dpi': 100, 'figsize': (28, 12)}, plot_file_name=f'EvokedInhRaster_{run_id}.png').plot({'SpikeRasterPlot.group_trials': True})
            ...
            if l23_flag:
                SpontActOverview(data_store, ParameterSet({'l4_exc_neuron': analog_ids[0], 'l4_inh_neuron': analog_ids_inh[0], 'l23_exc_neuron': analog_ids23[
                                 0], 'l23_inh_neuron': analog_ids_inh23[0]}), plot_file_name=f'SpontActOverview_{run_id}.png', fig_param={'dpi': dpi, 'figsize': (18, 14.5)}).plot()
                OrientationTuningSummaryAnalogSignals(data_store, ParameterSet({'exc_sheet_name1': 'V1_Exc_L4', 'inh_sheet_name1': 'V1_Inh_L4', 'exc_sheet_name2': 'V1_Exc_L2/3', 'inh_sheet_name2': 'V1_Inh_L2/3'}), fig_param={
                                                      'dpi': dpi, 'figsize': (18, 12)}, plot_file_name=f'OrientationTuningSummaryAnalogSignals_{run_id}.png').plot({'*.fontsize': 19, '*.y_lim': (0, None)})
                OrientationTuningSummaryFiringRates(data_store, ParameterSet({'exc_sheet_name1': 'V1_Exc_L4', 'inh_sheet_name1': 'V1_Inh_L4', 'exc_sheet_name2': 'V1_Exc_L2/3', 'inh_sheet_name2': 'V1_Inh_L2/3'}), fig_param={
                                                    'dpi': dpi, 'figsize': (18, 12)}, plot_file_name=f'OrientationTuningSummary_{run_id}.png').plot({'*.fontsize': 19})
                TrialToTrialVariabilityComparisonNew(data_store, ParameterSet({'sheet_name1': 'V1_Exc_L4', 'sheet_name2': 'V1_Exc_L2/3', 'data_dg': 0.93, 'data_ni': 1.19}), fig_param={
                                                     'dpi': dpi, 'figsize': (15, 7.5)}, plot_file_name=f'TrialToTrialVariabilityComparisonNew_{run_id}.png').plot()
            else:
                SpontActOverview(data_store, ParameterSet({'l4_exc_neuron': analog_ids[0], 'l4_inh_neuron': analog_ids_inh[0], 'l23_exc_neuron': -1,
                                                           'l23_inh_neuron': -1}), plot_file_name=f'SpontActOverview_{run_id}.png', fig_param={'dpi': dp, 'figsize': (18, 14.5)}).plot()
                OrientationTuningSummaryAnalogSignals(param_filter_query(data_store,st_contrast=[low_contrast,high_contrast]), ParameterSet({'exc_sheet_name1': 'V1_Exc_L4', 'inh_sheet_name1': 'V1_Inh_L4', 'exc_sheet_name2': 'None', 'inh_sheet_name2': 'None'}), fig_param={
                                                      'dpi': dpi, 'figsize': (18, 12)}, plot_file_name=f'OrientationTuningSummaryAnalogSignals_{run_id}.png').plot({'*.fontsize': 19, '*.y_lim': (0, None)})
                OrientationTuningSummaryFiringRates(data_store, ParameterSet({'exc_sheet_name1': 'V1_Exc_L4', 'inh_sheet_name1': 'V1_Inh_L4', 'exc_sheet_name2': 'None', 'inh_sheet_name2': 'None'}), fig_param={
                                                    'dpi': dpi, 'figsize': (18, 12)}, plot_file_name=f'OrientationTuningSummary_{run_id}.png').plot({'*.fontsize': 19})
            ...
            SpontStatisticsOverview(data_store, ParameterSet({}), fig_param={
                                    'dpi': dpi, 'figsize': (18, 12)}, plot_file_name=f'SpontStatisticsOverview_{run_id}.png').plot()

            if l23_flag:
                MRfigReal(param_filter_query(data_store, sheet_name=['V1_Exc_L2/3', 'V1_Exc_L4', 'V1_Inh_L2/3', 'V1_Inh_L4'], st_contrast=[high_contrast], st_name='FullfieldDriftingSinusoidalGrating'), ParameterSet(
                    {'SimpleSheetName': 'V1_Exc_L4', 'ComplexSheetName': 'V1_Exc_L2/3'}), plot_file_name=f'MRReal_{run_id}.png', fig_param={'dpi': dpi, 'figsize': (20, 9)}).plot()
            else:
                MRfigReal(param_filter_query(data_store, sheet_name=['V1_Exc_L4', 'V1_Inh_L4'], st_contrast=[high_contrast], st_name='FullfieldDriftingSinusoidalGrating'), ParameterSet(
                    {'SimpleSheetName': 'V1_Exc_L4', 'ComplexSheetName': 'None'}), plot_file_name=f'MRReal_{run_id}.png', fig_param={'dpi': dpi, 'figsize': (16, 12)}).plot()

            dsv = param_filter_query(
                data_store, st_name='NaturalImageWithEyeMovement')
            OverviewPlot(dsv, ParameterSet({'sheet_name': 'V1_Exc_L4', 'neuron': l4_exc, 'sheet_activity': {}, 'spontaneous': True}), plot_file_name=f'NMExc_{run_id}.png', fig_param={
                         'dpi': 100, 'figsize': (28, 12)}).plot({'Vm_plot.y_lim': (-70, -50), 'Conductance_plot.y_lim': (0, 50.0)})
            OverviewPlot(dsv, ParameterSet({'sheet_name': 'V1_Exc_L4', 'neuron': analog_ids[0], 'sheet_activity': {}, 'spontaneous': True}), plot_file_name=f'NMExc1_{run_id}.png', fig_param={
                         'dpi': 100, 'figsize': (28, 12)}).plot({'Vm_plot.y_lim': (-70, -50), 'Conductance_plot.y_lim': (0, 50.0)})
            OverviewPlot(dsv, ParameterSet({'sheet_name': 'V1_Exc_L4', 'neuron': analog_ids[1], 'sheet_activity': {}, 'spontaneous': True}), plot_file_name=f'NMExc2_{run_id}.png', fig_param={
                         'dpi': 100, 'figsize': (28, 12)}).plot({'Vm_plot.y_lim': (-70, -50), 'Conductance_plot.y_lim': (0, 50.0)})
            OverviewPlot(dsv, ParameterSet({'sheet_name': 'V1_Exc_L4', 'neuron': analog_ids[2], 'sheet_activity': {}, 'spontaneous': True}), plot_file_name=f'NMExc3_{run_id}.png', fig_param={
                         'dpi': 100, 'figsize': (28, 12)}).plot({'Vm_plot.y_lim': (-70, -50), 'Conductance_plot.y_lim': (0, 50.0)})
            OverviewPlot(dsv, ParameterSet({'sheet_name': 'V1_Exc_L4', 'neuron': analog_ids[3], 'sheet_activity': {}, 'spontaneous': True}), plot_file_name=f'NMExc4_{run_id}.png', fig_param={
                         'dpi': 100, 'figsize': (28, 12)}).plot({'Vm_plot.y_lim': (-70, -50), 'Conductance_plot.y_lim': (0, 50.0)})
            OverviewPlot(dsv, ParameterSet({'sheet_name': 'V1_Exc_L4', 'neuron': analog_ids[4], 'sheet_activity': {}, 'spontaneous': True}), plot_file_name=f'NMExc5_{run_id}.png', fig_param={
                         'dpi': 100, 'figsize': (28, 12)}).plot({'Vm_plot.y_lim': (-70, -50), 'Conductance_plot.y_lim': (0, 50.0)})
            OverviewPlot(dsv, ParameterSet({'sheet_name': 'V1_Inh_L4', 'neuron': l4_inh, 'sheet_activity': {}, 'spontaneous': True}), plot_file_name=f'NMInh_{run_id}.png', fig_param={
                         'dpi': 100, 'figsize': (28, 12)}).plot({'Vm_plot.y_lim': (-70, -50), 'Conductance_plot.y_lim': (0, 50.0)})
            OverviewPlot(dsv, ParameterSet({'sheet_name': 'X_ON', 'neuron': analog_ids_ON[0], 'sheet_activity': {}, 'spontaneous': True}), plot_file_name=f'NMON1_{run_id}.png', fig_param={
                         'dpi': 100, 'figsize': (28, 12)}).plot({'Vm_plot.y_lim': (-70, -50), 'Conductance_plot.y_lim': (0, 50.0)})
            OverviewPlot(dsv, ParameterSet({'sheet_name': 'X_ON', 'neuron': analog_ids_ON[1], 'sheet_activity': {}, 'spontaneous': True}), plot_file_name=f'NMON2_{run_id}.png', fig_param={
                         'dpi': 100, 'figsize': (28, 12)}).plot({'Vm_plot.y_lim': (-70, -50), 'Conductance_plot.y_lim': (0, 50.0)})
            OverviewPlot(dsv, ParameterSet({'sheet_name': 'X_ON', 'neuron': analog_ids_ON[2], 'sheet_activity': {}, 'spontaneous': True}), plot_file_name=f'NMON3_{run_id}.png', fig_param={
                         'dpi': 100, 'figsize': (28, 12)}).plot({'Vm_plot.y_lim': (-70, -50), 'Conductance_plot.y_lim': (0, 50.0)})
            OverviewPlot(dsv, ParameterSet({'sheet_name': 'X_ON', 'neuron': analog_ids_ON[3], 'sheet_activity': {}, 'spontaneous': True}), plot_file_name=f'NMON4_{run_id}.png', fig_param={
                         'dpi': 100, 'figsize': (28, 12)}).plot({'Vm_plot.y_lim': (-70, -50), 'Conductance_plot.y_lim': (0, 50.0)})
            OverviewPlot(dsv, ParameterSet({'sheet_name': 'X_ON', 'neuron': analog_ids_ON[4], 'sheet_activity': {}, 'spontaneous': True}), plot_file_name=f'NMON5_{run_id}.png', fig_param={
                         'dpi': 100, 'figsize': (28, 12)}).plot({'Vm_plot.y_lim': (-70, -50), 'Conductance_plot.y_lim': (0, 50.0)})
            OverviewPlot(dsv, ParameterSet({'sheet_name': 'X_OFF', 'neuron': analog_ids_OFF[0], 'sheet_activity': {}, 'spontaneous': True}), plot_file_name=f'NMOFF1_{run_id}.png', fig_param={
                         'dpi': 100, 'figsize': (28, 12)}).plot({'Vm_plot.y_lim': (-70, -50), 'Conductance_plot.y_lim': (0, 50.0)})
            OverviewPlot(dsv, ParameterSet({'sheet_name': 'X_OFF', 'neuron': analog_ids_OFF[1], 'sheet_activity': {}, 'spontaneous': True}), plot_file_name=f'NMOFF2_{run_id}.png', fig_param={
                         'dpi': 100, 'figsize': (28, 12)}).plot({'Vm_plot.y_lim': (-70, -50), 'Conductance_plot.y_lim': (0, 50.0)})
            OverviewPlot(dsv, ParameterSet({'sheet_name': 'X_OFF', 'neuron': analog_ids_OFF[2], 'sheet_activity': {}, 'spontaneous': True}), plot_file_name=f'NMOFF3_{run_id}.png', fig_param={
                         'dpi': 100, 'figsize': (28, 12)}).plot({'Vm_plot.y_lim': (-70, -50), 'Conductance_plot.y_lim': (0, 50.0)})
            OverviewPlot(dsv, ParameterSet({'sheet_name': 'X_OFF', 'neuron': analog_ids_OFF[3], 'sheet_activity': {}, 'spontaneous': True}), plot_file_name=f'NMOFF4_{run_id}.png', fig_param={
                         'dpi': 100, 'figsize': (28, 12)}).plot({'Vm_plot.y_lim': (-70, -50), 'Conductance_plot.y_lim': (0, 50.0)})
            OverviewPlot(dsv, ParameterSet({'sheet_name': 'X_OFF', 'neuron': analog_ids_OFF[4], 'sheet_activity': {}, 'spontaneous': True}), plot_file_name=f'NMOFF5_{run_id}.png', fig_param={
                         'dpi': 100, 'figsize': (28, 12)}).plot({'Vm_plot.y_lim': (-70, -50), 'Conductance_plot.y_lim': (0, 50.0)})

            TrialCrossCorrelationAnalysis(data_store, ParameterSet({'neurons1': list(analog_ids), 'sheet_name1': 'V1_Exc_L4', 'neurons2': list(
                analog_ids23), 'sheet_name2': 'V1_Exc_L2/3', 'window_length': 250}), fig_param={"dpi": dpi, "figsize": (15, 6.5)}, plot_file_name=f"trial-to-trial-cross-correlation_{run_id}.png").plot({'*.Vm.title': None, '*.fontsize': 19})
            ...
            PerNeuronValueScatterPlot(dsv, ParameterSet({'only_matching_units': False, 'ignore_nan': True, 'lexicographic_order': False, 'neuron_ids':[]}), plot_file_name=f'CVvsHWHH_{run_id}.png').plot(
            ...
            PerNeuronValuePlot(dsv,ParameterSet({"cortical_view" : True}),plot_file_name=f'ORSet_{run_id}.png').plot()

            LSV1MReponseOverview(data_store,ParameterSet
            ({'l4_exc_neuron' : l4_exc_or_many_analog[0], 'l4_inh_neuron' : l4_inh_or_many_analog[3],'l23_exc_neuron' : l23_exc_or_many_analog[5], 'l23_inh_neuron' : l23_inh_or_many_analog[2]}),
                                             fig_param={'dpi' : dpi,'figsize': (18,9)},plot_file_name=f'SingleCellOverview_{run_id}.png').plot(
                                                {'*.Vm_plot.x_ticks':[0,2000],
                                                 '*.Conductance_plot.x_ticks':[0,2000],
                                                 "*.title" : None,
                                                 '*.Vm_plot.y_lim' : (-80,-50),
            ...
            StimulusResponseComparison(data_store,ParameterSet({'neuron' : l4_exc_or_many_analog[8],'sheet_name' : 'V1_Exc_L4'}),fig_param={'dpi' : dpi,'figsize': (18,6)},plot_file_name=f'StimulusResponseComparison1L4_{run_id}.png').plot(
                                         {'*.Vm_plot.x_ticks':[0,2000], 
                                         '*.Conductance_plot.x_ticks':[0,2000], 
                                         "*.title" : None,
                                         '*.Vm_plot.y_lim' : (-80,-50),
            ...
            OrientationMapMatching(data_store,ParameterSet({}), plot_file_name=f'OrientationComparison_{run_id}.png',fig_param={'dpi' : dpi,'figsize': (6,6)}).plot()


def perform_analysis_and_visualization_spont(data_store, run_id, run_index=None):
    ...
    CrossCorrelationOfExcitatoryAndInhibitoryConductances(
        param_filter_query(data_store,st_direct_stimulation_name=None), ParameterSet({})
    ).analyse()
    NeuronToNeuronAnalogSignalCorrelations(
        param_filter_query(data_store,analysis_algorithm='PSTH'),ParameterSet({'convert_nan_to_zero' : True})
    ).analyse()

    dsv = param_filter_query(
        data_store, st_direct_stimulation_name=None, st_name="InternalStimulus", sheet_name=sheets, identifier='PerNeuronValue'
    )
    dsv.print_content()
    ...
    if run_index is not None:
        plot_file_name = f'Fig4_{run_id}_{run_index}.png'
    else:
        plot_file_name = f'Fig4_{run_id}.png'

    SpontStatisticsOverview(data_store,ParameterSet({}), fig_param={'dpi':dpi, 'figsize':(15,10)}, plot_file_name=plot_file_name).plot()
