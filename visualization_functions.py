...
class SpontStatisticsOverview(Plotting):
    ...
    def subplot(self, subplotspec):
        ...
        if True:
            ...
            r1 = pylab.barh(numpy.array([0.17,0.67]),[mean_CondE_L23E,mean_CondE_L4E],height = 0.12,color='#000000',edgecolor='#000000',xerr=[std_CondE_L23E,std_CondE_L4E],error_kw=dict(ecolor='gray', lw=2, capsize=5, capthick=2))
            r2 = pylab.barh(numpy.array([0.33,0.83]),[mean_CondE_L23I,mean_CondE_L4I],height = 0.12,color='#FFFFFF',edgecolor='#000000',xerr=[std_CondE_L23I,std_CondE_L4I],error_kw=dict(ecolor='gray', lw=2, capsize=5, capthick=2))
            pylab.ylim(0,1.0)
            pylab.xlim(0,2.0)
            pylab.yticks([0.25,0.75],['L2/3','L4'])
            ...
            r1 = pylab.barh(numpy.array([0.17,0.67]),[mean_CondI_L23E,mean_CondI_L4E],height = 0.12,color='#000000',edgecolor='#000000',xerr=[std_CondI_L23E,std_CondI_L4E],error_kw=dict(ecolor='gray', lw=2, capsize=5, capthick=2))
            r2 = pylab.barh(numpy.array([0.33,0.83]),[mean_CondI_L23I,mean_CondI_L4I],height = 0.12,color='#FFFFFF',edgecolor='#000000',xerr=[std_CondI_L23I,std_CondI_L4I],error_kw=dict(ecolor='gray', lw=2, capsize=5, capthick=2))
            pylab.ylim(0,1.0)
            pylab.xlim(0,10)
            pylab.yticks([0.25,0.75],['L2/3','L4'])
